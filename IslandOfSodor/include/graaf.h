...
template <RichtType RT>
Graaf<RT>::Graaf(const Graaf<RT> &g) : burenlijsten(g.burenlijsten), hoogsteVerbindingsnummer(g.hoogsteVerbindingsnummer){};
...
public:
    ...
    virtual void setTakdata(int van, int naar, const Takdata &);
...
template <RichtType RT, class Takdata>
void GraafMetTakdata<RT, Takdata>::setTakdata(int van, int naar, const Takdata &td) {
...
public:
    ...
    virtual void setKnoopdata(int knoopnummer, const Knoopdata &kd);
...
template <RichtType RT, class Knoopdata>
void GraafMetKnoopdata<RT, Knoopdata>::setKnoopdata(int knoopnummer, const Knoopdata &kd)
{
    knoopdatavector[knoopnummer] = kd;
}
